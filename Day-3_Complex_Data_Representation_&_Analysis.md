...
- `metadata ? 'technology'` returns `TRUE` if the `technology` key is present.
- It does not check the value of the key, only whether the key exists.
- This is useful for validating the structure of JSONB documents before querying their values.

### Screenshot

<img width="1194" height="559" alt="Screenshot 2026-07-21 at 9 40 29 PM" src="https://github.com/user-attachments/assets/d823b6db-5296-43a9-9689-e293edf4234b" />
...
The `?&` operator checks whether all specified keys exist in a JSONB document.

- `ARRAY['country','technology']` contains the list of required keys.
- The query returns only rows where both `country` and `technology` are present.
- If any one of the keys is missing, the row is not returned.
- This is useful when validating that a JSON document contains all mandatory attributes.

### Screenshot

<img width="1194" height="560" alt="Screenshot 2026-07-21 at 9 41 00 PM" src="https://github.com/user-attachments/assets/d3b33c11-1936-4377-8452-6c176b6b54c1" />
...
The `jsonb_pretty()` function formats a JSONB document into a human-readable structure.

- It adds indentation and line breaks to improve readability.
- The function does not modify the stored JSONB data.
- It is mainly used for debugging, documentation, and displaying JSON output in a more organized format.

### Screenshot

<img width="314" height="819" alt="Screenshot 2026-07-21 at 9 41 25 PM" src="https://github.com/user-attachments/assets/792fa632-fb94-452e-8f79-9cfcc58eaea7" />
